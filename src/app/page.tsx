...
const translations: Translations = {
  en: {
    description: "Explore fascinating experimental projects without writing a single line of code",
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-[#F2FFB3] to-[#E5FF7F] text-gray-800 py-16 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-16 relative">
          ...
          >
            <Badge variant="secondary" className="text-sm py-1 px-3 bg-[#E5FF7F] text-gray-800 border border-gray-200">
